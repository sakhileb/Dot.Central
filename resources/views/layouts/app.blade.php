...
<head>
    ...
    <style>
        :root { --accent: #7dd3fc; --accent-rgb: 125,211,252; }
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .brand-icon { width:36px; height:36px; border-radius:10px; background:rgba(125,211,252,0.12); border:1px solid rgba(125,211,252,0.22); display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .brand-icon .material-symbols-rounded { font-size:18px; color:#7dd3fc; }
